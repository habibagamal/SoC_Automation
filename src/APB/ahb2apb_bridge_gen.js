...
module.exports = {
	bridge_gen : function (address_space,Directory){
		var print = `
\`timescale 1ns/1ns
module ahb_2_apb(
// Global signals --------------------------------------------------------------
...
// APB Master outputs ----------------------------------------------------------
  ...
  output reg          PENABLE,
  output reg  [${address_space-1}:0]  PADDR,
  output reg          PWRITE,
...
//Constants
  ...
  wire          Transfer;
  wire          ACRegEn;
  reg   [${address_space-1}:0]  last_HADDR;
  reg           last_HWRITE;
  
  wire  [${address_space-1}:0]  HADDR_Mux;
...
var filename = Directory+"AHB_2_APB.v";
